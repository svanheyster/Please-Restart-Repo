...
public class FP_Camera : MonoBehaviour {
	...
	{
		//Evaluate distance based on smooth calculation
	...
	public static void UseExistingOrCreateNewMainCamera()
	{
		...
		tempCamera.AddComponent <FP_Camera> ();
		myCamera = tempCamera.GetComponent ("FP_Camera") as FP_Camera;
